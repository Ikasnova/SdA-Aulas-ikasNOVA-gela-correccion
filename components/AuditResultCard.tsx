...
const AuditResultCard: React.FC<Props> = ({ result, language }) => {
  ...
  return (
    <div className="bg-white overflow-hidden shadow-sm rounded-md border mb-3 transition-all" style={{ borderColor: colors.border }}>
      <div 
      ...
      {expanded && (
        <div className="border-t px-4 py-5 sm:p-6 bg-white" style={{ borderColor: colors.border }}>
          <p className="text-sm text-gray-600 mb-6 italic font-normal border-l-2 pl-3" style={{ borderColor: colors.blue }}>
            {result.observation}
          </p>
          
          {/* Detailed Check Table with Scroll for exhaustive lists on screen, full height on print */}
          <div 
